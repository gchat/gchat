              ...
              switch (category)
                ...
                case LC_NUMERIC:
                    return tlp->_numeric_using_locale
                        ? tlp->__lc_numeric->_numeric_locale_buf : "C";
                case LC_TIME:
                    return tlp->_time_using_locale
                        ? tlp->__lc_time->_time_locale_buf : "C";
                case LC_COLLATE:
                    return !tlp->__collate_load_error
                        ? tlp->__lc_collate->__encoding : "C";
                case LC_MONETARY:
                    return tlp->_monetary_using_locale
                        ? tlp->__lc_monetary->_monetary_locale_buf : "C";
                case LC_MESSAGES:
                    return tlp->_messages_using_locale
                        ? tlp->__lc_messages->_messages_locale_buf : "C";
