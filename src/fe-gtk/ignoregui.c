...
{
    return
        gtk_tree_view_get_model (g_object_get_data
                                 (G_OBJECT (ignorewin), "view"));
}
...
static void
mask_edited (GtkCellRendererText * render, gchar * path, gchar * new,
             gpointer dat)
{
