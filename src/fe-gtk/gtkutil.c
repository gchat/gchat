...
static void
gtkutil_file_req_response (GtkWidget * dialog, gint res,
...
void
gtkutil_file_req (const char *title, void *callback, void *userdata,
...
int
gtkutil_clist_multiple_selection (GtkWidget * clist, int **rows,
                                  const int max_rows)
{
    int i = 0;
    GList *tmp_clist;
...
gboolean
gtkutil_treemodel_string_to_iter (GtkTreeModel * model, gchar * pathstr,
