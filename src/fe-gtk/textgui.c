...
pevent_dialog_show ()
{
    ...
    pevent_dialog_list =
        gtkutil_treeview_new (th, GTK_TREE_MODEL (store), NULL,
                              COL_EVENT_NAME, _("Event"), COL_EVENT_TEXT,
                              _("Text"), -1);
    ...
    gtk_xtext_set_background (GTK_XTEXT (pevent_dialog_twid), channelwin_pix,
                              prefs.transparent);
