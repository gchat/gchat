...
{
	editlist_gui_open (NULL, NULL, command_list, _("GChat: User defined commands"),
...
menu_ulpopup (void)
{
	editlist_gui_open (NULL, NULL, popup_list, _("GChat: Userlist popup menu"), "popup",
...
menu_rpopup (void)
{
	editlist_gui_open (_("Text"), _("Replace with"), replace_list, _("GChat: Auto replace"), "replace",
							 "replace.conf", 0);
}
...
{
	editlist_gui_open (NULL, NULL, urlhandler_list, _("GChat: URL Handlers"), "urlhandlers",
...
menu_ulbuttons (void)
{
	editlist_gui_open (NULL, NULL, button_list, _("GChat: Userlist buttons"), "buttons",
...
{
	editlist_gui_open (NULL, NULL, dlgbutton_list, _("GChat: Dialog buttons"), "dlgbuttons",
...
{
	editlist_gui_open (NULL, NULL, ctcp_list, _("GChat: CTCP Replies"), "ctcpreply",
