...
int gtk_xtext_lastlog (xtext_buffer * out, xtext_buffer * search_area,
                       int (*cmp_func) (char *, void *userdata),
                       void *userdata);
textentry *gtk_xtext_search (GtkXText * xtext, const gchar * text,
                             textentry * start, gboolean case_match,
                             gboolean backward);
...
void gtk_xtext_set_tint (GtkXText * xtext, int tint_red, int tint_green,
                         int tint_blue);
