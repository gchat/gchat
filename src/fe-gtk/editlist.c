...
void
editlist_gui_open (char *title1, char *title2, GSList * list, char *title,
                   char *wmclass, char *file, char *help)
{
    ...
    editlist_gui_list = gtkutil_clist_new (2, titles, vbox, GTK_POLICY_ALWAYS,
                                           editlist_gui_row_selected, 0, editlist_gui_row_unselected, 0, GTK_SELECTION_BROWSE);
    ...
    button =
        gtkutil_button (hbox, GTK_STOCK_GO_DOWN, 0, editlist_gui_movedown, 0, _("Move Dn"));
    gtk_widget_set_usize (button, 100, 0);
    ...
    button = gtkutil_button (hbox, GTK_STOCK_SAVE, 0, editlist_gui_save, 0, _("Save"));
    gtk_widget_set_usize (button, 100, 0);
    ...
    button = gtkutil_button (hbox, GTK_STOCK_ADD, 0, editlist_gui_addnew, 0, _("Add New"));
    gtk_widget_set_usize (button, 100, 0);
    ...
    button =
        gtkutil_button (hbox, GTK_STOCK_SORT_ASCENDING, 0, editlist_gui_sort, 0, _("Sort"));
    gtk_widget_set_usize (button, 100, 0);

    button = gtkutil_button (hbox, GTK_STOCK_HELP, 0, editlist_gui_help, 0, _("Help"));
    gtk_widget_set_usize (button, 100, 0);
