...
main (int argc, char **argv)
{
    ...
    dbus_g_proxy_connect_signal (remote_object, "CommandSignal",
                                 G_CALLBACK (test_command_cb), NULL, NULL);
    ...
    dbus_g_proxy_connect_signal (remote_object, "ServerSignal",
                                 G_CALLBACK (test_server_cb), NULL, NULL);

    dbus_g_proxy_add_signal (remote_object, "UnloadSignal", G_TYPE_INVALID);
    dbus_g_proxy_connect_signal (remote_object, "UnloadSignal",
                                 G_CALLBACK (unload_cb), NULL, NULL);
