...
{
    tree_foreach (sess->usertree_alpha, (tree_traverse_func *) rehash_cb,
                  sess);
}
...
userlist_flat_list (session * sess)
{
    ...
    tree_foreach (sess->usertree_alpha, (tree_traverse_func *) flat_cb,
                  &list);
...
userlist_double_list (session * sess)
{
    ...
    tree_foreach (sess->usertree_alpha, (tree_traverse_func *) double_cb,
                  &list);
    return list;
}
